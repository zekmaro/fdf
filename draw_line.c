...
/*   Updated: 2024/07/01 12:39:46 by anarama          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_line(t_vars *vars, unsigned long color,  int height)
{
	...
	while (1)
	{
		color = calculate_gradient(vars->colors->white, vars->colors->red, vars->map, height);
		put_pixel_to_image(vars->image, x0, y0, color);
